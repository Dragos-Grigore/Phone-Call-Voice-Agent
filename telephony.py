...
ngrok_url = "https://catarina-tensed-berry.ngrok-free.dev" # asta o luati din terminal dupa comanda: ngrok http 5000 -> ex: https://catarina-tensed-berry.ngrok-free.dev
...
active_agent = VoiceAgent(called_hotel) # aici ar trebui sa vina instanta de agent care face stt-llm-tts si foloseste tool urile

@app.route('/dial')
def dial_hotel():
    call = client.calls.create(
        url=f"{ngrok_url}/voice",
        to="+40764067966", # adaugati nr vostru aici
